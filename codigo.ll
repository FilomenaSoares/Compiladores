...
@msg0 = constant [24 x i8] c"Digite um valor para a:\00"
@msg1 = constant [24 x i8] c"Digite um valor para b:\00"
...
call i32 (i8*, ...) @printf(i8* getelementptr ([24 x i8], [24 x i8]* @msg1, i32 0, i32 0))
